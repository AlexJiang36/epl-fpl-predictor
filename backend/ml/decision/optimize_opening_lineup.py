    ...
    return build_run_metadata(
        ...
        provenance={
            ...
            "notes": [
                ...
                "Official chance_of_playing_next_round propagation remains a known pre-freeze follow-up.",
...
def build_report(
    ...
    return {
        ...
        "availability_scope": {
            ...
            "official_chance_of_playing_next_round_propagated": False,
            "required_follow_up": "Fix availability propagation after Day101B and rerun before GW1 final freeze.",
        },
        "scope_boundary": {
        ...
        "warnings": [
            ...
            "Known official availability propagation gap remains to be fixed after Day101B.",
...
def build_markdown_report(report: Mapping[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "> Expected minutes, start probability, appearance probability, eligibility, fallback, uncertainty, and risk flags are used/preserved. Official `chance_of_playing_next_round` is not yet propagated end-to-end and remains a required pre-freeze fix.",
        "",
        "## Stop point",
        "",
